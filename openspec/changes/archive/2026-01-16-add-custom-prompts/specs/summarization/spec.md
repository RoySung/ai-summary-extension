...
-   **Previous Behavior**: System always used the single configured global prompt.
-   **New Behavior**: System MUST accept an optional specific prompt instruction. If no specific prompt is provided, the system MUST use the user's configured **Default Prompt**.
