...
4.  **Settings UI** (`entrypoints/options/`)
    - `entrypoints/settings/` now hosts the primary full-page settings experience.
    - `entrypoints/options/` remains as a compatibility redirect entrypoint.
...
- `entrypoints/settings/`: Primary full-page settings UI.
- `entrypoints/options/`: Compatibility redirect for browser options entry.
